...
import AdditionalExperience from '../AdditionalExperience/AdditionalExperience';
import AddressDetails from '../AddressDetails/AddressDetails';
import ContactDetails from '../ContractDetails/ContractDetails';
import CovidStatus from '../CovidStatus/CovidStatus';
import CreditDetails from '../CreditDetails/CreditDetails';
import DutiesWillingToPerform from '../DutiesWillingToPerform/DutiesWillingToPerform';
import FamilyDetails from '../FamilyDetails/FamilyDetails';
import LastWorkPlaces from '../LastWorkPlaces/LastWorkPlaces';
import MedicalConditionsExperience from '../MedicalConditionsExperience/MedicalConditionsExperience';
import MedicalProceduresExperience from '../MedicalProceduresExperience/MedicalProceduresExperience';
        ...
        <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={handleSubmit}>
            {({ values, handleChange, errors, touched }) => (
                <Form className="contact-form">
                    <PersonalDetails values={values} handleChange={handleChange} errors={errors} touched={touched} />
                    <FamilyDetails values={values} handleChange={handleChange} />
                    <AddressDetails values={values} handleChange={handleChange} />
                    <ContactDetails values={values} handleChange={handleChange} errors={errors} touched={touched} />
                    <WorkDetails values={values} handleChange={handleChange} />
                    <MedicalConditionsExperience values={values} handleChange={handleChange} />
                    <MedicalProceduresExperience values={values} handleChange={handleChange} />
                    <DutiesWillingToPerform values={values} handleChange={handleChange} />
                    <AdditionalExperience values={values} handleChange={handleChange} />
                    <CreditDetails values={values} handleChange={handleChange} />
                    <CovidStatus values={values} handleChange={handleChange} />
                    <RecommendationDetails values={values} handleChange={handleChange} />
                    <LastWorkPlaces values={values} handleChange={handleChange} />
                    <CriminalAndCarOwnership values={values} handleChange={handleChange} />
                    <CaredAgeGroup values={values} handleChange={handleChange} />

                    {/* Declaration */}
                    <Box className="form-section">
                        <FormControlLabel
                            control={<Checkbox name="declaration" checked={values.declaration} onChange={handleChange} />}
                            label="Настоящим заявляю, что вся вышеизложенная информация соответствует действительности."
                        />
                        <FormControlLabel
                            control={<Checkbox name="declaration" checked={values.declaration} onChange={handleChange} />}
                            label={
                                <>
                                    Отправляя данную форму, я принимаю условия <Link to="/contract">Договора</Link> и{' '}
                                    <Link to="/privacy-policy">Политики обработки персональных данных</Link>
                                </>
                            }
                        />
                    </Box>
